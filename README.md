A script that uses a python script that decifers a metadata file, finds the corresponding asset combinations a user wants for a specific 3D model design, 
